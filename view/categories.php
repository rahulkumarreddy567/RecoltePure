...
<div class="container">
    ...
    <div class="pagination">
        <?php if ($page > 1): ?>
            <a class="page-btn"
                href="?page=categories&category_id=<?= $categoryId ?>&sort=<?= $sort ?>&search=<?= $search ?>&p=<?= $page - 1 ?>">Prev</a>
        <?php endif; ?>
        ...
        <?php if ($page < $totalPages): ?>
            <a class="page-btn"
                href="?page=categories&category_id=<?= $categoryId ?>&sort=<?= $sort ?>&search=<?= $search ?>&p=<?= $page + 1 ?>">Next</a>
        <?php endif; ?>
    </div>
</div>
