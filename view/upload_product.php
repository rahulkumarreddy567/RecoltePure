...
<div class="upload-container">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <input type="text" name="product_name"
            value="<?php echo $controller->edit_mode ? htmlspecialchars($controller->product['product_name']) : ''; ?>"
            required>

        <label>Description</label>
        <textarea name="description" rows="4"
            required><?php echo $controller->edit_mode ? htmlspecialchars($controller->product['product_description']) : ''; ?></textarea>
