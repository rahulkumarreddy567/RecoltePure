                    ...
                    <tbody>
                        <?php if (!empty($products)): ?>
                            <?php foreach ($products as $product): ?>
                                <tr>
                                    <td>
                                        <img src="assets/uploads/products/<?= $product['image'] ?>" width="50"
                                    ...
                                    <td>
                                        <?php if ($product['stock_quantity'] <= 5): ?>
                                            <span class="status status-pending" style="background:#fff3e0; color:#ef6c00;">Low Stock
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="5" style="text-align:center; padding: 40px;">No products found for this farmer.
                                </td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
